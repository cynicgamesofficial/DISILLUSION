...
**DISILLUSION** is an experimental real-time rendering engine platform focused on modern GPU ray tracing workflows, deterministic performance behavior, and classic mod-driven engine architecture.
...
DISILLUSION aims to evolve beyond a simple engine fork into a lightweight rendering platform where developers can fully understand runtime behavior, experiment with modern rendering techniques, and build gameplay systems as dynamically loaded modules.

---

## Engine Direction

DISILLUSION follows a renderer-centric philosophy.
...
DISILLUSION adopts a classic engine platform model inspired by late-generation Quake-style designs.
...
DISILLUSION builds upon the technical foundations of **Quake II RTX**, itself derived from:
...
The DISILLUSION engine runtime is distributed under the **GNU General Public License v2**.
